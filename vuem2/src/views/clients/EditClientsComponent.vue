    ...
    <DashboardComponent>
        <div slot="slot-pages" class="content-pages">
            <b-card class="card shadow mx-4">
                <b-row class="mx-2">
                    <b-col>
                        <h2 class="text-start" v-if="form.last_update != ''"><i class="fa fa-user"></i> {{form.name.text}}</h2>
                    ...
                    <b-row class="mt-4 px-2">
                        ...
                        <b-col cols="12" md="3">
                            <b-form-group id="input-group-stats" label="Status" label-for="input-stats">
                                <b-form-select id="input-stats" v-if="form.last_update" v-model="form.stats.text" :state="form.stats.statsInput" :options="status" class="form-control"  />
                                <b-form-select id="input-stats" v-else v-model="form.stats.text" :state="form.stats.statsInput" :options="status" class="form-control"  />
                        ...
                        <b-col cols="12" md="3">
                            <b-form-group id="input-group-sex" label="Sexo" label-for="input-sex">
                                <b-form-select id="input-sex" v-if="form.last_update" v-model="form.sex.text" :state="form.sex.statsInput" :options="sexos" class="form-control"  />
                                <b-form-select id="input-sex" v-else v-model="form.sex.text" :state="form.sex.statsInput" :options="sexos" class="form-control"  />
        ...
        methods: {
            ...
            onUpdate() {
                ...
                console.log(this.retorno);
                    console.log('123');
                    this.$http.put(`/clients/update/${this.$route.params.client}`, this.dataForm('addUp')).then((response) => {
                        console.log('1234');
            ...
            onSubmit(event) {
                if (this.viaCep()) {
                    this.$http.post('/clients/adicionar', this.dataForm('addUp')).then((response) => {
                        if (response.data == 'success') {
                            this.dataForm('statsInput');
                            this.statsButton = true
                            this.countDownChanged(this.dismissSecs)
